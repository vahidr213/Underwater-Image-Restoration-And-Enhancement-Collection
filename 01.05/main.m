...
% % % •	Get Restored Red Channel Intensities with Final Joint UDCP + IATP Matrix Eq.18 [1]
  ...
  saliencymap = saliency_detection(im2uint8(medtransMat3),2);%% 2nd saliency method, very slow
...
endif  figure('name',resfilename),imshow(cat(2, im2uint8(imrestored), imref ));
