...
SobelR = abs(imfilter(Ir,hx,'same') + imfilter(Ir,hy,'same'));
SobelG = abs(imfilter(Ig,hx,'same') + imfilter(Ig,hy,'same'));
SobelB = abs(imfilter(Ib,hx,'same') + imfilter(Ib,hy,'same'));
