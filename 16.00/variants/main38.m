...
% subtract an optimum constant from H3,V3,D3,H2,V2,D2,H1,V1,D1
%  band of wavelet for Hue + Saturation channels
...
if (v1 < 0) || (v1 > 0.1) 
    ...
    for i = 1:2
        ...
        level = 2; % 1= first 2=2nd ... to smaller subbands
        whichcoef = 2; % 1=H 2=V 3=D
